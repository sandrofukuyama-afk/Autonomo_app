...
class ReceiptPdfService {
  ...
  static pw.Widget _thermalBody(ReceiptData data, _Labels l, pw.Font font, {required bool compact}) {
    ...
    return pw.Column(
      ...
      children: [
        ...
        pw.Text('${l.receipt} ${l.receiptNumber}: ${data.receiptNumber}', style: style(bold: true)),
        pw.Text('${l.date}: ${_fmtDate(data.issueDate, data.language)}', style: style()),
        if (data.clientName != null) pw.Text('${l.issuedTo}: ${data.clientName}', style: style()),
        pw.Text(divider(n), style: style()),
        pw.Text(data.description, style: style()),
        pw.Text(divider(n), style: style()),
        ...
        pw.Text(divider(n), style: style()),
        _thermalRow(l.total, _fmt(data.total, l.currencyFmt), style, bold: true, size: tsB),
        pw.Text(divider(n), style: style()),
          ...
          child: pw.Row(
            ...
            children: [
              ...
              pw.Column(crossAxisAlignment: pw.CrossAxisAlignment.end, children: [
                ...
                pw.Text(_fmtDate(data.issueDate, data.language), style: r(size: 9).copyWith(color: const PdfColor.fromInt(0xFFBDBDBD))),
              ]),
            ],
          ),
        ),
        ...
        if (data.clientName != null)
          pw.Container(
            ...
            child: pw.Row(children: [
              ...
              pw.Text(data.clientName!, style: b(size: 10)),
        ...
        pw.Align(
          ...
          child: pw.Container(
            ...
            child: pw.Column(children: [
              ...
              _pagedTotalRow(l.total, _fmt(data.total, l.currencyFmt), r, g, bold: b(size: 13)),
            ]),
          ),
        ),
  ...
  static String buildEmailHtml(ReceiptData data) {
    ...
    final clientRow = data.clientName != null
        ? '<p style="margin:0 0 4px"><strong>${l.issuedTo}:</strong> ${data.clientName}${data.clientEmail != null ? ' &lt;${data.clientEmail}&gt;' : ''}</p>'
        : '';
...
<title>${l.receipt} ${data.receiptNumber}</title>
</head>
...
<div style="max-width:560px;margin:32px auto;background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 4px 16px rgba(0,0,0,.12)">
  ...
  <div style="background:#1A1A2E;padding:24px 28px;display:flex;justify-content:space-between;align-items:flex-start">
    ...
    <div style="text-align:right">
      <span style="background:#1E88E5;color:#fff;padding:4px 12px;border-radius:6px;font-size:14px;font-weight:bold">${l.receipt}</span>
